    ...
    <footer className="w-full bg-surface-container-low dark:bg-surface-container-low">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-surface-container-highest">
          ...
          {/* Navigation */}
          <div>
            <p className="font-label-caps text-xs text-on-surface-variant uppercase tracking-widest mb-4">Navigation</p>
          ...
          {/* Réseaux sociaux */}
          <div>
            <p className="font-label-caps text-xs text-on-surface-variant uppercase tracking-widest mb-4">Nous retrouver</p>
            <div className="flex flex-col gap-3">
              <a href="https://www.instagram.com/beauty_home.concept" target="_blank" rel="noreferrer" className="font-body-md text-sm text-on-surface-variant hover:text-primary transition-colors flex items-center gap-2">
              ...
              <a href="https://www.tiktok.com/@beautyhomeconcept" target="_blank" rel="noreferrer" className="font-body-md text-sm text-on-surface-variant hover:text-primary transition-colors flex items-center gap-2">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.31 6.31 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.87a8.18 8.18 0 004.79 1.54V7.01a4.84 4.84 0 01-1.02-.32z"/></svg>
                @beautyhomeconcept
              </a>
              <a href="https://www.facebook.com/beautyhomeconcept" target="_blank" rel="noreferrer" className="font-body-md text-sm text-on-surface-variant hover:text-primary transition-colors flex items-center gap-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 gap-4">
          <p className="font-label-caps text-xs text-on-surface-variant">
            © {new Date().getFullYear()} Beauty Home Concept · Amiens, France
          </p>
